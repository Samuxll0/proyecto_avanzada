...
*Nota: Estudiantes y Docentes pueden registrarse libremente usando el endpoint `/auth/register` siempre que usen sus dominios institucionales (@estudiante.triagre.com / @docente.triagre.com).*
